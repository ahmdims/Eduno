<div class="rbt-team-modal modal fade rbt-modal-default" id="updateModal-{{ $user_data->id }}" tabindex="-1"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{ route('admin.student.update', $user_data->id) }}" method="POST">
                @csrf
                @method('PUT')
                            ...
                            <div class="rbt-form-group">
                                ...
                                <div class="rbt-modern-select bg-transparent height-45">
                                    <select name="gender" class="form-control">
                                        <option value="" {{ $user_data->gender == '' ? 'selected' : '' }}>Select
                                            Gender
                                        </option>
                                        ...
                                        <option value="Female" {{ $user_data->gender == 'Female' ? 'selected' : '' }}>
                                            Female</option>
                                        <option value="Other" {{ $user_data->gender == 'Other' ? 'selected' : '' }}>
                                            Other
                                        </option>
                                    </select>
                                </div>
                                ...
                                <div class="rbt-modern-select bg-transparent height-45">
                                    <select name="utype" class="form-control">
                                        <option value="student" {{ $user_data->utype == 'student' ? 'selected' : '' }}>
                                            Student</option>
                                        <option value="admin" {{ $user_data->utype == 'admin' ? 'selected' : '' }}>
                                            Admin
                                        </option>
                                    </select>
                                </div>
