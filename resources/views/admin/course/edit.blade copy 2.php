                            ...
                            <div class="card-body pt-0">
                                <div class="row g-10">
                                    <div class="col-md-6">
                                        ...
                                        <div class="mb-10 fv-row">
                                            ...
                                            <select name="category_id" class="form-select form-select-solid"
                                                ...
                                                <option value="{{ $category->id }}" {{ $course->category_id ==
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-10 fv-row">
                                            ...
                                            <input type="text" name="video" value="{{ old('video', $course->video) }}"
                                                class="form-control form-control-solid" required />
                                        </div>
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <textarea name="description" id="description_hidden"
                                        class="d-none">{{ old('description', $course->description) }}</textarea>
